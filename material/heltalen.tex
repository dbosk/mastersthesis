...
\begin{definition}
	Ett element \(x\) i en mängd med en definierad operation \(\diamond\)
	kallas för \emph{inversen till \(y\)} om och endast om det för något \(y\)
	uppfyller att \(y\diamond x = e\), där \(e\) är identitetselementet under
	operationen.
\end{definition}
...
\begin{definition}[Algebraiska egenskaper hos de hela talen]
	...
	\begin{description}
		...
		\item[Additivt identitetselement] Det finns ett element \(0\in\R\)
			sådant att för alla \(a\in\R\) gäller att \(0+a = a+0 = a\).
	...
	\begin{description}
		...
		\item[Multiplikativt identitetselement] Det finns ett element
			\(1\in\R\) sådant att för alla \(a\in\R\) gäller att
			\(1 \cdot a = a \cdot 1 = a\).
...
\begin{theorem}\label{thm:KvotenMindre}
