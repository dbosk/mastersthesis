...
\((a,b)\sim (a,b)\), och följdaktligen är den reflexiv.
...
följdaktligen att \(a+f = b+e\) som betyder att \((a,b)\sim (e,f)\).
...
\begin{example}
	...
	Följdaktligen har vi \([(0,0)]=[(1,1)]\) och \((1,1)\in [(0,0)]\), men
...
%	\([(2,0)]\), och \(a\) beteckna \([(a,0)]\) för alla naturliga tal \(a\).
%	Låt dessutom \(-a\) beteckna den additiva inversen \([(0,a)]\) till
%	\([(a,0)]\).
%\end{definition}
\begin{figure}[t]
	\centering
...
\begin{exercise}
	...
	Gäller denna ordning även för relationen \(<\) definierad för hela tal?
...
\noindent
\lettrine{V}{i är redan} bekanta med de naturliga talen, och därmed också den
...
\begin{proof}
	...
	Följdaktligen får vi att \(a(1+(-1))=0\) eftersom att vi då multiplicerar
	\(a\) med noll.
...
\begin{definition}
	...
	Om \(a^{n}\) är definierat för något naturligt tal \(n\), då är
	\(a^{n+1} = a\cdot a^n\).
	Vi utläser \(a^n\) som en \(a\)-\emph{potens} med \emph{exponenten} \(n\).
\end{definition}
