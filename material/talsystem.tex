...
\begin{proof}[Bevis \thmref{thm:PositionssystemAllaUnika}]
	...
	Vi hade först att \(x=q_1b+r_1\), men \(q_1=q_2b+r_2\) och följdaktligen är
	\[x=(q_2b+r_2)b+r_1.\]
...
\begin{proof}
	...
	Vi har således \(d_1=1\), \(d_2=b-2\) och följdaktligen
	\(x=1\cdot b+(b-2)\).
...
\begin{proof}
	...
	\(r_b(x_{i+k}+y_i)=x_{i+k}+y_i\) och då får vi även med det andra
	fallet.
